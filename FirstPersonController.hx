...
class FirstPersonController extends Trait {
        ...
        function preUpdate() {
            ...
            if (mouse.locked || mouse.down()) {
                var deltaTime = iron.system.Time.delta; // Obtener el deltaTime para ajustar la velocidad
        ...
        function update() {
            ...
            var deltaTime = iron.system.Time.delta; // Obtener deltaTime
